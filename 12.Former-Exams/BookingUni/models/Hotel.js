...
const hotelSchema = new Schema({
    name: { type: String, required: true, unique: true, minlength: [4, 'Hotel name must more than 4 characters'] },
    city: { type: String, required: true, minlength: [3, 'City name must more than 3 characters'] },
    imageUrl: { type: String, required: true, validate: {
        validator: () => {URL_PATTERN.test(value)},
