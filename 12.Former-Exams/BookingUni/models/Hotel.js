...
const hotelSchema = new Schema({
    name: { type: String, required: true, unique: true, minlength: [4, 'Hotel name must be more than 4 characters'] },
    city: { type: String, required: true, minlength: [3, 'City name must be more than 3 characters'] },
